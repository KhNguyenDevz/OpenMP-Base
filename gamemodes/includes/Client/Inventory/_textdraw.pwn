hook OnPlayerConnect(playerid) {
	...
	ItemBackground[playerid][1] = CreatePlayerTextDraw(playerid, 97.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][2] = CreatePlayerTextDraw(playerid, 131.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][3] = CreatePlayerTextDraw(playerid, 165.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][4] = CreatePlayerTextDraw(playerid, 199.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][5] = CreatePlayerTextDraw(playerid, 233.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][6] = CreatePlayerTextDraw(playerid, 97.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][7] = CreatePlayerTextDraw(playerid, 131.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][8] = CreatePlayerTextDraw(playerid, 165.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][9] = CreatePlayerTextDraw(playerid, 199.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][10] = CreatePlayerTextDraw(playerid, 233.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][11] = CreatePlayerTextDraw(playerid, 97.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][12] = CreatePlayerTextDraw(playerid, 131.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][13] = CreatePlayerTextDraw(playerid, 165.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][14] = CreatePlayerTextDraw(playerid, 199.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][15] = CreatePlayerTextDraw(playerid, 233.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][16] = CreatePlayerTextDraw(playerid, 97.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][17] = CreatePlayerTextDraw(playerid, 131.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][18] = CreatePlayerTextDraw(playerid, 165.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][19] = CreatePlayerTextDraw(playerid, 199.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][20] = CreatePlayerTextDraw(playerid, 233.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][21] = CreatePlayerTextDraw(playerid, 346.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][22] = CreatePlayerTextDraw(playerid, 380.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][23] = CreatePlayerTextDraw(playerid, 414.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][24] = CreatePlayerTextDraw(playerid, 448.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][25] = CreatePlayerTextDraw(playerid, 482.000, 123.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][26] = CreatePlayerTextDraw(playerid, 346.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][27] = CreatePlayerTextDraw(playerid, 380.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][28] = CreatePlayerTextDraw(playerid, 414.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][29] = CreatePlayerTextDraw(playerid, 448.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][30] = CreatePlayerTextDraw(playerid, 482.000, 166.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][31] = CreatePlayerTextDraw(playerid, 346.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][32] = CreatePlayerTextDraw(playerid, 380.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][33] = CreatePlayerTextDraw(playerid, 414.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][34] = CreatePlayerTextDraw(playerid, 448.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][35] = CreatePlayerTextDraw(playerid, 482.000, 210.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][36] = CreatePlayerTextDraw(playerid, 346.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][37] = CreatePlayerTextDraw(playerid, 380.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][38] = CreatePlayerTextDraw(playerid, 414.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][39] = CreatePlayerTextDraw(playerid, 448.000, 254.000, "mdl-2003:bg_item");
	...
	ItemBackground[playerid][40] = CreatePlayerTextDraw(playerid, 482.000, 254.000, "mdl-2003:bg_item");
	...
	btnInv[playerid][0] = CreatePlayerTextDraw(playerid, 279.000, 158.000, "mdl-2003:btnUse");
	...
	btnInv[playerid][1] = CreatePlayerTextDraw(playerid, 279.000, 177.000, "mdl-2003:btnDrop");
	...
	btnInv[playerid][2] = CreatePlayerTextDraw(playerid, 279.000, 197.000, "mdl-2003:btnTrade");
	...
	btnInv[playerid][3] = CreatePlayerTextDraw(playerid, 279.000, 216.000, "mdl-2003:btnInfo");
	...
	btnPage[playerid][0] = CreatePlayerTextDraw(playerid, 97.000, 298.000, "mdl-2003:btnPre");
	...
	btnPage[playerid][1] = CreatePlayerTextDraw(playerid, 219.000, 298.000, "mdl-2003:btnNext");
	...
	btnPage[playerid][3] = CreatePlayerTextDraw(playerid, 346.000, 298.000, "mdl-2003:btnPre");
	...
	btnPage[playerid][4] = CreatePlayerTextDraw(playerid, 468.000, 298.000, "mdl-2003:btnNext");
