...
new const itemInfo[][InventoryItem_Info] = {
	...
	{5, "mdl-2003:item_mp5", "Sung MP5", "Sung tieu lien tu dong, su dung vu khi va sau do su dung hop dan."},
	{6, "mdl-2003:item_m4", "Sung M4", "Sung truong tu dong, su dung dan Rifle, su dung vu khi va sau do su dung hop dan."},
	{7, "mdl-2003:item_shotgun", "Sung Shotgun", "Sung shotgun , su dung dan Shotgun, su dung vu khi va sau do su dung hop dan."},
	{8, "mdl-2003:item_uzi", "Sung Uzi", "Sung tieu lien , nho gon , su dung cho cac nhiem vu tan cong bat ngo"},
	{9, "mdl-2003:item_tec9", "Sung Tec9", "Sung tieu lien , nho gon , su dung cho cac nhiem vu tan cong bat ngo"},
	{10, "mdl-2003:item_de", "Sung DE", "Sung luc , nho gon , sat thuong cuc lon, de dang ha guc muc tieu"},
	{11, "mdl-2003:item_smallshotgun", "Sawnoff Shotgun", "Sung shotgun loai nho , nho gon , su dung cho cac nhiem vu tan cong bat ngo"},
	{12, "mdl-2003:item_sniperRifle", "Sinper Rifle", "Sung tia, su dung cho cac nhiem vu ho tro , ban tia tam xa"},
	{13, "mdl-2003:item_tickdiscount10", "Counpon 10", "Ve giam gia 10 phan tram tai cac cua hang"},
	{14, "mdl-2003:item_tickdiscount15", "Counpon 15", "Ve giam gia 15 phan tram tai cac cua hang"},
	{15, "mdl-2003:item_tickdiscount25", "Counpon 10", "Ve giam gia 25 phan tram tai cac cua hang"},
	{16, "mdl-2003:item_dirtymoney", "Tien Ban", "Su dung de mua hang tai Black Market"},
	{17, "mdl-2003:item_cocacola", "Coca", "Dung de uong va tang the luc"},
	{18, "mdl-2003:item_sprite", "Sprite", "Dung de uong va tang the luc"},
	{19, "mdl-2003:item_pepper", "Pepper", "Dung de uong va tang the luc"},
	{20, "mdl-2003:item_prime", "Prime", "Dung de uong va tang the luc"},
	{21, "mdl-2003:driver_license", "Driver License", "Giay Phep Lai Xe"},
	{22, "mdl-2003:id_card", "CCCD", "Can Cuoc Cong Dan"},
	{23, "mdl-2003:weaponlicense", "Weapon License", "Giay phep su dung sung"}
};
